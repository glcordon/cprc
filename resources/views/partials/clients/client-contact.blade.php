...
       <div class="row">
    <div class="card-column col-3">
        ...
        <div class="card-body">
            <div class="card-text"> 
                    {{ $clients->profile->address_1 }} <br>
                    {{ $clients->profile->address_2 ?? '' }} <br>
                    {{ $clients->profile->city }}, {{ $clients->profile->state }}, {{ $clients->profile->zip }} <br>
                    <a href="tel:{{ $clients->profile->primary_phone }}">{{ $clients->profile->primary_phone }}</a><br />
                    <a href="mailTo:{{ $clients->profile->email }}">{{ $clients->profile->email }}</a>
